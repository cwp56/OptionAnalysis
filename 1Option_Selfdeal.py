...
if __name__ == '__main__':
	...
	queryStr = "select distinct internal_order_id as internal_order_id from zce_option_trade where '%s' <= time and time < '%s';" % (queryDate.strftime('%Y-%m-%dT%H:%M:%SZ'), (queryDate + timedelta(seconds=durationSecs)).strftime('%Y-%m-%dT%H:%M:%SZ'))
